...
export const Rosado = new character("Rosado", classInfo.wyvernKnightLanceAxe, true, characterGrowthRate.rosadoGrowths, characterMaxStats.rosadoMaxStats, characterBaseStats.rosadoBaseStats, 3, 20, availableClasses.male, rosadoImage, proficiencies.axe, personalSkills.rosadoSkill)
