...
export const wyvernKnightSwordLance = new classData("Wyvern Knight", wyvernKnightGrowths, wyvernKnightCaps, wyvernKnightBaseStats, types.flier, weaknesses.dragonFlier, proficiencies.mountedSwordLance, skills.airRaid);
export const wyvernKnightSwordAxe = new classData("Wyvern Knight", wyvernKnightGrowths, wyvernKnightCaps, wyvernKnightBaseStats, types.flier, weaknesses.dragonFlier, proficiencies.mountedSwordAxe, skills.airRaid);
export const wyvernKnightLanceAxe = new classData("Wyvern Knight", wyvernKnightGrowths, wyvernKnightCaps, wyvernKnightBaseStats, types.flier, weaknesses.dragonFlier, proficiencies.mountedAxeLance, skills.airRaid);
